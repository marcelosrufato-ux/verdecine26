        ...
        <Container size="xl">
          <Grid gutter={50} justify="center">
            ...
            <Grid.Col span={{ base: 12, md: 4 }}>
              ...
              <ul>
                <li>
                  <a href="/edicao-2026/programacao" className="underline">
                    Progamação
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a
                    href="/edicao-2026/sobre/o-festival#ficha-tecnica"
                    className="underline"
                  >
                    Ficha Técnica da edição 2026
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/edicao-2026/sobre/associacao-verdecine" className="underline">
