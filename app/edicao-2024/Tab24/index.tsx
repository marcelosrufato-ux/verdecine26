          ...
          <div className="py-5">
            ...
            <ul>
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-8">
                    DENTE / 20 minutos / PE{" "}
                  </Link>
                  <Tooltip
                    arrowOffset={10}
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-9">
                    GRÃO / 15 minutos / MT{" "}
                  </Link>
                </small>
              </li>
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-15">
                    TERRA QUE ALIMENTA / 15 minutos / SP
                  </Link>
                  <br />
                  <Link className="underline" href="/edicao-2024/filmes#filme-16">
              ...
              <li className="text-xl text-vc-light my-2 py-1">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-4">
          ...
          <div className="py-5">
            ...
            <ul>
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-10">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-1">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                18:20 - Exibição do filme seguido de bate papo
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-7">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-14">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-13">
                    PENSAO ALIMENTICIA / 16 minutos / GO <br />
                  </Link>
                  <Link className="underline" href="/edicao-2024/filmes#filme-19">
          ...
          <div className="py-5">
            ...
            <ul>
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-3">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-6">
              ...
              <li className="text-xl text-vc-light  py-4 ">
                20:50 - Exibição do filme seguido de bate papo
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-5">
          ...
          <div className="py-5">
            ...
            <ul>
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                16:10 - Exibição do filme seguido de bate papo
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-12">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-17">
              ...
              <li className="text-xl text-vc-light border-b-2 py-4 border-[#ffffff23]">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-11">
              ...
              <li className="text-xl text-vc-light  py-4">
                ...
                <small className="block opacity-75">
                  <Link className="underline" href="/edicao-2024/filmes#filme-18">
